...
class UI:
	...
	def output(self, text, toStdout=False, targetStream=None):
		...
		transliteration.
		"""
		if "Sleeping for" in text or "Page" in text and "[[" in text and "]]" in text and "saved" in text:
			return
		elif "WARNING: core/lib/pywikibot/family.py:930: FamilyMaintenanceWarning: Family name wikimediachapter does not match family module name wikimedia" in text:
			return
